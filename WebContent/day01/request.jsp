...
<title>request 对象应用实例2—-考试系统</title>
</head>
<body>
<h3>第六章测试题</h3>
...
设定指定的名字的HTTP文件头的值<br>
<input type="radio" name="1" value="C">
判定指定名字的HTTP文件头是否存在<br>
...
<input type="radio" name="2"value="B" >getAttibuteName()<br>
...
3.能清除缓冲区的数据，并且把数据输出到客户端是out对象中的方法是().<br>
...
用来设置默认页面的范围或指定的范围之中的已命对象<br>
<input type="radio" name="4"value="B" >
用来删除默认页面的范围或指定范围之中已命的对象<br>
<input type="radio" name="4"value="C" >按照页面请会话以及应用程序范围的顺序实现对某个已命名属性的搜索<br>
